...
for pkg in pkg_dfs:
    ...
    p.varea_stack(stackers=names, x='month', color=Blues4[:len(names)], legend_label=names, source=df)
    p.vline_stack(stackers=names, x='month', color=Blues4[:len(names)], source=df)
